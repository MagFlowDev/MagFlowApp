...
{
    public class WarehouseSectorRow : StatusEntity, IBaseEntity, ICodeEntity, ISoftDeletable
    {
        [Key]
        ...
        [NotMapped]
        public override Enums.HistoryEntityType EntityType => Enums.HistoryEntityType.WarehouseSectorRow;
