...
{
    public class Product : StatusEntity, IBaseEntity, ICodeEntity, ISoftDeletable, IHistoryEntity
    {
        [Key]
        ...
        [NotMapped]
        public override Enums.HistoryEntityType EntityType => Enums.HistoryEntityType.Product;
