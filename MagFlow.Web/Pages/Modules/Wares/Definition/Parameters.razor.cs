...
namespace MagFlow.Web.Pages.Modules.Wares.Definition
{
    public partial class Parameters
    {
        ...
        private async Task<GridData<ParameterDTO>> ServerReloadProducts(GridState<ParameterDTO> state, CancellationToken token)
        {
            ...
            sortBy = sortBy ?? "Id";
            var queryOptions = new MagFlow.Shared.Models.QueryOptions<MagFlow.Domain.CompanyScope.CustomParameter>()
            {
            ...
            var response = await ProductService.GetParameters(queryOptions);
