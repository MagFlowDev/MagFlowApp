...
namespace MagFlow.EF.Migrations.CompanyDb
{
    ...
    [Migration("20260910114515_Update2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MagFlow.Domain.CompanyScope.DefaultWorkingHour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MagFlow.Domain.CompanyScope.StockMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MagFlow.Domain.CompanyScope.StockMovement", b =>
                {
                    ...
                    b.HasOne("MagFlow.Domain.CompanyScope.WarehouseSectorRow", "SourceRow")
                        .WithMany()
                        .HasForeignKey("SourceRowId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.WarehouseSector", "SourceSector")
                        .WithMany()
                        .HasForeignKey("SourceSectorId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.WarehouseSectorRowSlot", "SourceSlot")
                        .WithMany()
                        .HasForeignKey("SourceSlotId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.Warehouse", "SourceWarehouse")
                        .WithMany()
                        .HasForeignKey("SourceWarehouseId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.WarehouseSectorRow", "TargetRow")
                        .WithMany()
                        .HasForeignKey("TargetRowId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.WarehouseSector", "TargetSector")
                        .WithMany()
                        .HasForeignKey("TargetSectorId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.WarehouseSectorRowSlot", "TargetSlot")
                        .WithMany()
                        .HasForeignKey("TargetSlotId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MagFlow.Domain.CompanyScope.Warehouse", "TargetWarehouse")
                        .WithMany()
