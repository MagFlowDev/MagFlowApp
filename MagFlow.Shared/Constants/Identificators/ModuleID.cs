...
namespace MagFlow.Shared.Constants.Identificators
{
    ...
    {
        public static Guid USERS_MODULE_ID = new Guid("7893801e-e494-4d78-8ee5-7ba212e3f44e");
        public static Guid CONTRACTORS_MODULE_ID = new Guid("fb2390a3-235c-4da3-b2ba-a4daeba93b41");
        public static Guid WARES_MODULE_ID = new Guid("6eda8523-aa5e-4027-bab6-c60cd32232c9");
        public static Guid ORDERS_MODULE_ID = new Guid("f794c153-05e8-4684-8bc2-b3b2eb914b42");
        public static Guid DOCUMENTS_MODULE_ID = new Guid("855157a6-73a0-4c2e-800d-cfc37fc8f42f");
